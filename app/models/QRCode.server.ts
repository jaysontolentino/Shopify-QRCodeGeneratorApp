...
export function getDestinationUrl(qrCode:  QRCode | null) {

  invariant(qrCode !== null, "Expected QRCode data");
...
async function supplementQRCode(qrCode: QRCode | null, graphql: GraphQLClient<AdminOperations>) {
...
export type TSupplementQRCode = Awaited<ReturnType<typeof supplementQRCode>>;