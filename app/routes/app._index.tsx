...
import { getQRCodes, TSupplementQRCode } from "../models/QRCode.server";
...
const QRTable = ({ qrCodes }: { qrCodes: SerializeFrom<Array<TSupplementQRCode>> }) => (
  <IndexTable
    resourceName={{
      singular: "QR code",
      plural: "QR codes",
...
const QRTableRow = ({ qrCode }: { qrCode: SerializeFrom<TSupplementQRCode> }) => (
